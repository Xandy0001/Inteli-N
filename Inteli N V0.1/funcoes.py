...
lhorario = ['QUAL E A HORA', 'FALA A HORA', 'QUANTAS HORAS', 'HORARIO', 'QUANTAS HORAS SAO', 'HORA', 'DIA É HOJE', 'QUE DIA ESTAMOS', 'DATA']
...
lfuncoes = ['O QUE VOCÊ PODE FAZER', 'FUNÇÕES', 'LISTA DE FUNÇÕES']
#______________________________________________________________________________________________
